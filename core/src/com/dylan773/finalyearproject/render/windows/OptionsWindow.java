 ...
 * @author Dylan Brand
 */
public class OptionsWindow extends WindowBuilder { // extract to a table
        ...
        protected void initWindow() {
            ...
            addWindowLabel("OPTIONS", "title", this).colspan(2).row();
            addWindowLabel("Audio", "subtitle", this).padBottom(10f).colspan(2).row();
            addWindowLabel("Music Volume:", "default", this).right().padBottom(5f);
            add(musicSlider).fillX().padBottom(5f).row();
            addWindowLabel("SFX Volume:", "default", this).right().padBottom(5f);
